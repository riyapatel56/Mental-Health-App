...
class MyHomePages extends StatefulWidget {
  ...
  MyHomePages({required this.opendrawer});
          ...
          children: [
            ...
            Row(
              children: [
                ...
                //   decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: Color.fromARGB(255, 8, 120, 172),),
                //   child: Padding(
            ...
            Padding(
              ...
              child: Flexible(
                            child: Text(
                              'Your objective is to spend all of it to bring your current mental issue level down to an ideal level before the day ends.',
                              style: GoogleFonts.lato(
